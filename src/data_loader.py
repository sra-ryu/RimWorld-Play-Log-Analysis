...
def load_colonist_data(rws_path: str):
    ...
    for pawn_id, pawn in enumerate(pawns):
        ...
        for s in pawn.findall("skills/skills/li"):
            skill_name = s.findtext("def")
            skills[skill_name] = s.findtext("level") or 0
            passions[skill_name] = PASSION_MAP.get(s.findtext("passion"), 0)
        ...
        for skill_name in ALL_SKILLS:
            skill_list.append({
                ...
                "passion": passions.get(skill_name, 0)
            })
